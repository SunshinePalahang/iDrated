...
class NotificationAdapter(private val notifications: List<NotificationEntry>) :
    ...
    override fun onBindViewHolder(holder: NotificationViewHolder, position: Int) {
        ...
        holder.relativeTimeText.text = getRelativeTime(notification.timestamp)
    }
    ...
    class NotificationViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val relativeTimeText: TextView = itemView.findViewById(R.id.notificationTime)
    }
}
